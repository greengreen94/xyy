...
TABLE_CONFIG = {
    ...
    "gov_procurement_info1": {
        "fields": [
            ...
            "original_link", "html", "bid_document_time", "bid_document_price",
            "bid_document_location", "bid_opening_time", "bid_opening_location", "budget_amount",
            "project_contact", "project_phone", "procurement_address", "procurement_contact",
            "agency_name", "agency_address", "agency_contact", "attachment_list"
        ]
    },
    "public_resources_info_new": {
        "fields": [
            "id", "task_id", "project_name", "regions", "source_platform", "business_type",
            "message_amount", "industries", "announcement_time", "info_source", "original_url",
            "project_code", "procurement_method", "budget_amount", "procurement_requirements",
            "contract_period", "accept_joint_bid", "applicant_qualification", "bid_doc_obtain_time",
            "bid_doc_price", "bid_submission_deadline", "announcement_period", "purchaser_name",
            "purchaser_address", "purchaser_contact", "agency_name", "agency_address",
            "agency_contact", "bid_details", "winning_supplier", "review_experts", "agency_fee",
            "bid_control_price", "winning_price", "purchaser_info", "agency_info", "project_contact",
            "attachments", "section_code", "section_name", "construction_unit", "project_type",
            "contracting_type", "project_manager_name", "project_manager_id", "joint_venture_units",
            "winning_period", "winning_time", "project_location", "detail_url", "html_content",
            "origin_text", "attachment_paths", "create_time", "update_time", "website",
            "acquisition_source", "analytic_result"
